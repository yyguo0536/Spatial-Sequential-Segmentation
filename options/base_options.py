...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--first_net_path', metavar='DIR', type=str, default=None, help='Network path?')
        parser.add_argument('--second_net', action='store_true', default=False, help='Use two Net?')
        parser.add_argument('--evaluation', action='store_true', default=False,
                    help='Argument to train model (default: False)')
        parser.add_argument('--first_net', type=str, default='unet256', help='The first network name')
