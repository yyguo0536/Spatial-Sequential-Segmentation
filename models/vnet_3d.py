...
class VNet_3d_ALL_TEST(nn.Module):
    def __init__(self, classes_num = 6):
        classes = classes_num
        super(VNet_3d_ALL_TEST, self).__init__()
        self.in_block = VNetInBlock(2, 24, 2)
        self.down_block1 = VNetDownBlock(24, 48, 2)#48*48*48
        self.down_block2 = VNetDownBlock(48, 64, 2)#24*24*24
        self.down_block3 = VNetDownBlock(64, 128, 2)#12*12*12
    ...
    def forward(self, combined12, image1_96, image2_96):
        _, _, field12_96 = self.forward_branch(combined12)

        inter1_96 = self.warp_layer96(image1_96, field12_96[:,0,:,:,:], field12_96[:,1,:,:,:], field12_96[:,2,:,:,:])

        inter_field_96_1 = -self.warp_layer96(field12_96[:,3:,:,:,:], field12_96[:,3,:,:,:], field12_96[:,4,:,:,:], field12_96[:,5,:,:,:])
        ...
        inter2_96 = self.warp_layer96(image2_96, field12_96[:,3,:,:,:], field12_96[:,4,:,:,:], field12_96[:,5,:,:,:])

        
        inter_field_96_2 = -self.warp_layer96(field12_96[:,:3,:,:,:], field12_96[:,0,:,:,:], field12_96[:,1,:,:,:], field12_96[:,2,:,:,:])
        ...
        return fake1_96, fake2_96, field12_96, inter1_96, inter2_96
...
class MNet_3d_back(nn.Module):
    def __init__(self, classes_num = 2):
        classes = classes_num
        super(MNet_3d_back, self).__init__()
        self.in_block = VNetInBlock(1, 24, 2)
        self.down_block1 = VNetDownBlock(24, 48, 2)
        self.down_block2 = VNetDownBlock(48, 64, 2)
        ...
        self.up_block4 = VNetUpBlock(256, 64, 128, 2)
        #self.out24_1 = VNetInBlock(100, 64, 2)
        self.out24_2 = VNetInBlock(128, 32, 2)
        self.out24_3 = VNetOutSingleBlock(32, classes)
        self.up_block5 = VNetUpBlock(128, 48, 64, 2)
        self.out48_1 = VNetInBlock(64, 32, 2)
        #self.out48_2 = VNetInBlock(64, 32, 2)
        self.out48_3 = VNetOutSingleBlock(32, classes)
        self.up_block6 = VNetJustUpBlock(64, 32, 2)
        #self.out96_1 = VNetInBlock(64, 32, 1)
        self.out96_block = VNetOutSingleBlock(32, classes)
